...
public class CalculatorModel {
    ...
    public double isCalculation() throws CalculatorError {
        ...
        if(userInputCalculation.contains(" ") == false){
            ...
            throw new CalculatorError("잘못된 연산자 입니다.");
        }
        }
    ...
    public static boolean isNumber(String input) { //숫자와 문자열을 제외한 문자를 입력하는지 확인하는 메서드
